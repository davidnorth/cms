...
var TinyMCE_AdvancedImagePlugin = {
	getInfo : function() {
		return {
			longname : 'White label image',
			author : 'Moxiecode Systems AB + John Leach',
	...
	execCommand : function(editor_id, element, command, user_interface, value) {
		switch (command) {
			case "mceAdvImage":
				...
				template['file']   = whitelabel_imagesurl;
				template['width']  = 520;
				template['height'] = 520;
        ...
        imageLibraryCallback = function(image){
          ...
          tinyMCE._setEventsEnabled(inst.getBody(), false);
				...
				tinyMCE.openWindow(template, {editor_id : editor_id, scrollbars: "1", inline : "yes"});
...
tinyMCE.addPlugin("whitelabel_image", TinyMCE_AdvancedImagePlugin);
